    ...
    protected void onStart() {
        ...
        participantIntentFilter
                .addAction(applicationContext.getString(R.string.domain_name) +
                        applicationContext.getString(R.string.song_finished_downloading));
        // When the host presses Play for the session playlist, the session playlist should play on
        // the participant's device.
        participantIntentFilter.addAction(applicationContext.getString(R.string.domain_name) +
        ...
        participantIntentFilter.addAction(applicationContext.getString(R.string.domain_name) +
                applicationContext.getString(R.string.playlist_ready));
        participantMusicPlayerReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                {
                    createMediaPlayer();
                } else if (action.equals(applicationContext.getString(R.string.domain_name) +
                        applicationContext.getString(R.string.play))) {
                    play();
                } else if (action.equals(applicationContext.getString(R.string.domain_name) +
                        applicationContext.getString(R.string.pause))) {
